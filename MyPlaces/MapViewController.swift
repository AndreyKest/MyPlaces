...
//  MyPlaces
//
//  Created by Alina Kostanovkaya on 10.12.2021.
//
...
class MapViewController: UIViewController {
    ...
    private func checkLocationAuthorization() {
        ...
        case .denied:
            DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
                self.showAlert(title: "Your Location is not Availeble", message: "To give permission Go to: Setting -> MyPlaces -> Location")
            }
            break
